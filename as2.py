...
# If the user selects 'E', the program will end
if category_type == 'E':
    print("Thanks you. You are now exiting the program ")
else:
    # Assign the corresponding list based on user's input
    if category_type == 'S':
    ...
    # Input for instruction type (A: Add, D: Delete, S: Sort, I: Search, P: Previous menu)
...
# Dictionary of actors' birthdays
actors_birthdays = {
...
# Dictionary of favorite movies with release year
favorite_movies = {
    "Inception": 2010,
...
# Dictionary of favorite games with release year
favorite_games = {
    'The Last of Us': 2013,
    'God of War': 2018,
...
# Function to sort the dictionary by keys (alphabetical order)
...
if function_type == "A":
    ...
    listname = add_value2(listname, name, value)

elif function_type == "D":
    name = input("Enter the value you want to delete: ")
    listname = delete_value2(listname, name)
    ...
    value = input("Enter the Name you want to find: ")
    listname = searching_value2(listname, value)
